          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-1.5 pl-4 border-l border-white/10">
              <a
                ...
                rel="noreferrer"
                aria-label="WhatsApp"
                className="w-6 h-6 rounded flex items-center justify-center text-[#2fe873] hover:bg-[#25d366]/15 transition-all"
              >
                <svg
                  width="15"
                  height="15"
              ...
              <a
                ...
                className="w-6 h-6 rounded flex items-center justify-center text-[#f44867] hover:bg-[#e4405f]/15 transition-all"
              >
                <svg
                  width="15"
                  height="15"
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="Facebook"
                className="w-6 h-6 rounded flex items-center justify-center text-[#3186f5] hover:bg-[#1877f2]/15 transition-all"
              >
                <svg
                  width="15"
                  height="15"
