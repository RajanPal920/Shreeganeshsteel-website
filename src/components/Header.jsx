...
const Header = () => {
  ...
  return (
    <>
      {/* ============ TOP BAR — COMPACT ============ */}
      <div className="bg-[#0a1628] text-white/60 text-[0.68rem] sm:text-[0.72rem] border-b border-white/10">
        <div className="max-w-[1320px] mx-auto px-5 sm:px-8 py-1.5 flex flex-col sm:flex-row items-center justify-between gap-1.5 sm:gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-5">
            ...
            <a
              ...
              className="hidden xs:inline-flex sm:inline-flex items-center gap-1.5 text-white/65 hover:text-[#c9a961] transition-colors font-medium"
            >
              <svg
                width="12"
                height="12"
