            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-2 text-white font-bold text-sm px-7 py-3.5 rounded-lg transition-all duration-300 bg-[#C8102E] hover:bg-[#0B3E8C] shadow-[0_10px_30px_rgba(200,16,46,0.3)] hover:-translate-y-0.5"
                >
                  Send Inquiry
                </a>
                <Link
