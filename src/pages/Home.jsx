...
export default function Home() {
  ...
  // ✅ PRELOAD all hero images once on mount
  useEffect(() => {
    ...
    <div className="w-full overflow-x-hidden bg-white text-[#1a1a1a]">
      <main>
        ...
        <section id="home" className="relative w-full bg-white">
          <div className="relative w-full h-[calc(85vh-100px)] sm:h-[calc(100vh-100px)] lg:h-[calc(95vh-90px)] min-h-[550px] sm:min-h-[650px] lg:min-h-[600px] overflow-hidden bg-[#0B3E8C]">
            {heroSlides.map((s, i) => (
              <div
                key={s.id}
