          ...
          <div className="relative z-10 w-full max-w-[1320px] mx-auto px-5 sm:px-8 py-16 sm:py-20">
            ...
            <div className="max-w-2xl mx-auto text-center backdrop-blur-xl bg-[#0B3E8C]/40 border border-white/20 rounded-2xl sm:rounded-3xl px-5 sm:px-8 lg:px-10 py-7 sm:py-8 ">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-[3.5rem] font-bold tracking-tight leading-[1.05] mb-5">
                {material.name}
                <br />
                <em className="not-italic text-red-400">Product Range.</em>
              </h1>

              {/* Description */}
              <p className="text-white font-bold leading-relaxed max-w-2xl mx-auto text-base sm:text-lg mb-6">
                {material.longDesc}
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-6">
                {material.grades.map((g, i) => (
                  <span
                    key={i}
                    className="text-[0.7rem] font-bold tracking-wider uppercase bg-white/10 border border-white/20 px-3 py-1.5 rounded-full text-white font-bold"
                  >
                    {g}
                  </span>
                ))}
              ...
              <div className="flex flex-wrap justify-center gap-x-10 gap-y-4 pt-6 border-t border-white/20 max-w-md mx-auto">
                <div>
                  ...
                  <div className="text-[0.78rem] font-bold tracking-widest uppercase text-white mt-1.5">
                    Products Available
                  </div>
                </div>
                <div>
